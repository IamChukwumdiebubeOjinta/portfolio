        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }}>
            ...
            <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
              ...
              <span className="text-secondary font-medium">AI-native systems</span>.
            </p>
            <motion.div
            ...
            >
              <Button variant="ghost" size="icon" className="hover:text-primary hover:bg-primary/10 transition-chelsea">
                <Github className="h-5 w-5" />
              </Button>
              <Button variant="ghost" size="icon" className="hover:text-primary hover:bg-primary/10 transition-chelsea">
                <Linkedin className="h-5 w-5" />
              </Button>
              <Button variant="ghost" size="icon" className="hover:text-secondary hover:bg-secondary/10 transition-chelsea">
