  ...
  const projects = await Promise.all([
    prisma.project.upsert({
      ...
      create: {
        ...
        imageUrl: '/images/projects/thumbnails/uloma-ai-assistant-thumbnail.jpg',
        isVisible: true,
        isFeatured: true,
        status: 'PUBLISHED',
        order: 1,
        ...
        images: {
          create: [
            {
              url: '/images/projects/thumbnails/uloma-ai-assistant-thumbnail.jpg',
              alt: 'Uloma AI Assistant - AI-powered chat interface',
              type: 'thumbnail',
              isPrimary: true,
              order: 0,
              width: 300,
            ...
            {
              url: '/images/projects/gallery/uloma-ai-assistant-gallery-1.jpg',
              alt: 'Uloma AI Assistant - Chat interface screenshot',
              type: 'gallery',
              isPrimary: false,
              order: 1,
              width: 1200,
            ...
            {
              url: '/images/projects/logos/uloma-ai-assistant-logo.png',
              alt: 'Uloma AI Assistant Logo',
              type: 'logo',
              isPrimary: false,
              order: 2,
              width: 200,
