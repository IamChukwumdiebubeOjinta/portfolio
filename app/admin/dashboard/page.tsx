...
import { FolderOpen, FileText, Settings, Eye, Users, TrendingUp, Plus, Edit } from "lucide-react"
...
const recentActivity = [
  { action: "Updated project", item: "Uloma AI Assistant", time: "2 hours ago" },
  { action: "Published blog post", item: "Building AI Applications", time: "1 day ago" },
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Welcome back, Ebube! Here's what's happening with your portfolio.</p>
        </div>
