...
import { Plus, Search, Edit, Trash2, ExternalLink, Github, Eye, EyeOff } from "lucide-react"
...
export default function ProjectsManager() {
  ...
  const toggleVisibility = (id: string) => {
    setProjects(projects.map((project) => (project.id === id ? { ...project, visible: !project.visible } : project)))
  }
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center gap-2">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <Switch checked={project.visible} onCheckedChange={() => toggleVisibility(project.id)} />
                      </div>
                    </div>
